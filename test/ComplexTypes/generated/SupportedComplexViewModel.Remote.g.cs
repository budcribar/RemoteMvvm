...
{
    public partial class SupportedComplexViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IDisposable
    {
        private SupportedComplexViewModelGrpcServiceImpl? _grpcService;
        ...
        public SupportedComplexViewModel(ServerOptions options) : this()
        {
            ...
            _grpcService = new SupportedComplexViewModelGrpcServiceImpl(this, _dispatcher);
        ...
        private void StartAspNetCoreServer(ServerOptions options)
        {
            ...
            // Map gRPC services
            app.MapGrpcService<SupportedComplexViewModelGrpcServiceImpl>()
               .EnableGrpcWeb()
        ...
        public async Task<SupportedComplexViewModelRemoteClient> GetRemoteModel()
        {
