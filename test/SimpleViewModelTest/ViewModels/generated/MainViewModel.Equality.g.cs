...
{
    public partial class MainViewModel : IEquatable<MainViewModel>
    {
        private static readonly string[] __eqProps = new []{"Devices"};
        ...
        public override bool Equals(object? obj) => Equals(obj as MainViewModel);
        ...
        public List<string> DeepDiff(MainViewModel? other)
        {
