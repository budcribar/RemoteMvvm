export class ReadmeComponentView {
    render(): HTMLElement {
        ...
        <div class="readme-paragraph">
            ...
            For a more accurate result, look up the installed CPU on <a href="https://ark.intel.com/content/www/us/en/ark.html">Intel ARK</a>, and set the 'Temperature threshold to DTS' slider to a value that is ~90% of the reported DTS Max.
        ...
        <div>
            The tool was developed in collaboration with the <a href="https://www.microsoft.com/store/apps/9P4PNDG7L782">HP PC Hardware Diagnostics Windows</a> development team.
