...
public partial class HP3LSThermalTestViewModelGrpcServiceImpl : Generated.Protos.HP3LSThermalTestViewModelService.HP3LSThermalTestViewModelServiceClient
{
    ...
    private readonly HPSystemsTools.ViewModels.HP3LSThermalTestViewModel _viewModel;
    ...
    public HP3LSThermalTestViewModelGrpcServiceImpl(HPSystemsTools.ViewModels.HP3LSThermalTestViewModel viewModel, ILogger<HP3LSThermalTestViewModelGrpcServiceImpl>? logger = null)
    {
    ...
    private Generated.Protos.UpdatePropertyValueResponse UpdatePropertyValueInternal(Generated.Protos.UpdatePropertyValueRequest request)
    {
        ...
        try
        {
            Debug.WriteLine($"[GrpcService:HP3LSThermalTestViewModel] UpdatePropertyValue: Property={request.PropertyName}, Path={request.PropertyPath}, Operation={request.OperationType}");
    ...
    private Generated.Protos.UpdatePropertyValueResponse HandleSetOperation(Generated.Protos.UpdatePropertyValueRequest request, string propertyPath)
    {
        ...
        catch (Exception ex)
        {
            response.Success = false;
            response.ErrorMessage = ex.Message;
            Debug.WriteLine($"[GrpcService:HP3LSThermalTestViewModel] Error in HandleSetOperation: {ex}");
        }
    ...
    public override Task<Generated.Protos.StateChangedResponse> StateChanged(Generated.Protos.StateChangedRequest request, ServerCallContext context)
    {
        var response = new Generated.Protos.StateChangedResponse();
        ...
        {
            Debug.WriteLine("[GrpcService:HP3LSThermalTestViewModel] Error executing command StateChanged: " + ex);
            _logger?.LogError(ex, "Error executing command StateChanged");
        }
        
        return Task.FromResult(response);
    }

    public override Task<Generated.Protos.CancelTestResponse> CancelTest(Generated.Protos.CancelTestRequest request, ServerCallContext context)
    {
        var response = new Generated.Protos.CancelTestResponse();
        ...
        {
            Debug.WriteLine("[GrpcService:HP3LSThermalTestViewModel] Error executing command CancelTest: " + ex);
