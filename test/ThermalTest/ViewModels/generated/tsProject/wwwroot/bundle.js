...
/*!********************!*\
  ...
  \********************/
__webpack_require__.r(__webpack_exports__);
Object(function webpackMissingModule() { var e = new Error("Cannot find module './generated/HP3LSThermalTestViewModelServiceClientPb'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const grpcClient = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './generated/HP3LSThermalTestViewModelServiceClientPb'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(grpcHost);
...
async function render() {
    document.getElementById('cpuTemperatureThreshold').value = JSON.stringify(vm.cpuTemperatureThreshold);
    document.getElementById('cpuLoadThreshold').value = JSON.stringify(vm.cpuLoadThreshold);
    document.getElementById('cpuLoadTimeSpan').value = JSON.stringify(vm.cpuLoadTimeSpan);
    document.getElementById('zoneList').value = JSON.stringify(vm.zoneList);
...
document.addEventListener('DOMContentLoaded', () => {
    init();
    document.getElementById('cpuTemperatureThreshold').addEventListener('change', (e) => {
    ...
    document.getElementById('cpuLoadThreshold').addEventListener('change', (e) => {
        const newValue = e.target.value;
    ...
    document.getElementById('cpuLoadTimeSpan').addEventListener('change', (e) => {
        const newValue = e.target.value;
    ...
    document.getElementById('zoneList').addEventListener('change', (e) => {
        const newValue = e.target.value;
    ...
    document.getElementById('testSettings').addEventListener('change', (e) => {
        const newValue = e.target.value;
    ...
    document.getElementById('showDescription').addEventListener('change', (e) => {
        const newValue = e.target.value;
    ...
    document.getElementById('showReadme').addEventListener('change', (e) => {
        const newValue = e.target.value;
