...
async function render() {
    ...
    document.getElementById('zoneList').value = JSON.stringify(vm.zoneList, null, 2);
    document.getElementById('testSettings').value = JSON.stringify(vm.testSettings, null, 2);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('zoneList').addEventListener('change', async (e) => {
        const newValue = e.target.value;
    ...
    document.getElementById('testSettings').addEventListener('change', async (e) => {
        const newValue = e.target.value;
