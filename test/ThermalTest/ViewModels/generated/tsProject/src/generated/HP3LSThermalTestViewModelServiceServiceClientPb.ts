...
export class HP3LSThermalTestViewModelServiceClient {
  ...
  getState(
    ...
    request,
    metadata || {},
    this.methodDescriptorGetState).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {
  ...
  updatePropertyValue(
    ...
    request,
    metadata || {},
    this.methodDescriptorUpdatePropertyValue).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {
  ...
  stateChanged(
    ...
    request,
    metadata || {},
    this.methodDescriptorStateChanged).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {
  ...
  cancelTest(
    ...
    request,
    metadata || {},
    this.methodDescriptorCancelTest).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {
  ...
  ping(
    ...
    request,
    metadata || {},
    this.methodDescriptorPing).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {).catch((err: any) => {
