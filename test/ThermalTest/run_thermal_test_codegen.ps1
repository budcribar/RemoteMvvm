...
$viewModel3 = Join-Path $baseDir "ViewModels\ThermalStateEnum.cs"
$viewModel4 = Join-Path $baseDir "ViewModels\TestSettingsModel.cs"
$viewModel5 = Join-Path $baseDir "ViewModels\Zone.cs"
$viewModels = "'$viewModel1'", "'$viewModel2'", "'$viewModel3'", "'$viewModel4'", "'$viewModel5'" -join " "
