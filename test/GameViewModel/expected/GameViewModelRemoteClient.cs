// Auto-generated by GrpcRemoteMvvmGenerator at 7/4/2025 5:21:59 AM
...
namespace MonsterClicker.RemoteClients
{
                            ...
                            try
                            {
                                ...
                                switch (update.PropertyName)
                                {
                                    case nameof(MonsterName):
                                        if (update.NewValue!.Is(StringValue.Descriptor)) { var val = update.NewValue.Unpack<StringValue>().Value; Debug.WriteLine($"Updating MonsterName from \"{this.MonsterName}\" to '\"{val}\"."); this.MonsterName = val; Debug.WriteLine($"After update, MonsterName is '\"{this.MonsterName}\"."); } else { Debug.WriteLine($"Mismatched descriptor for MonsterName, expected StringValue."); }
                                        break;
                                    ...
                                    case nameof(GameMessage):
                                        if (update.NewValue!.Is(StringValue.Descriptor)) { var val = update.NewValue.Unpack<StringValue>().Value; Debug.WriteLine($"Updating GameMessage from \"{this.GameMessage}\" to '\"{val}\"."); this.GameMessage = val; Debug.WriteLine($"After update, GameMessage is '\"{this.GameMessage}\"."); } else { Debug.WriteLine($"Mismatched descriptor for GameMessage, expected StringValue."); }
                                        break;
                                    case nameof(IsMonsterDefeated):
                                        if (update.NewValue!.Is(BoolValue.Descriptor)) { var val = update.NewValue.Unpack<BoolValue>().Value; Debug.WriteLine($"Updating IsMonsterDefeated from {this.IsMonsterDefeated} to {val}."); this.IsMonsterDefeated = val; Debug.WriteLine($"After update, IsMonsterDefeated is {this.IsMonsterDefeated}."); } else { Debug.WriteLine($"Mismatched descriptor for IsMonsterDefeated, expected BoolValue."); }
                                        break;
                                    ...
                                    case nameof(IsSpecialAttackOnCooldown):
                                        if (update.NewValue!.Is(BoolValue.Descriptor)) { var val = update.NewValue.Unpack<BoolValue>().Value; Debug.WriteLine($"Updating IsSpecialAttackOnCooldown from {this.IsSpecialAttackOnCooldown} to {val}."); this.IsSpecialAttackOnCooldown = val; Debug.WriteLine($"After update, IsSpecialAttackOnCooldown is {this.IsSpecialAttackOnCooldown}."); } else { Debug.WriteLine($"Mismatched descriptor for IsSpecialAttackOnCooldown, expected BoolValue."); }
                                        break;
