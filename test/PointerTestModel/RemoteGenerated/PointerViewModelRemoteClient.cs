...
namespace HPSystemsTools.RemoteClients
{
    public partial class PointerViewModelRemoteClient : ObservableObject, IDisposable
    {
        ...
        public IRelayCommand<MouseEventArgs> OnClickTestCommand { get; }
        ...
        public PointerViewModelRemoteClient(Pointer.ViewModels.Protos.PointerViewModelService.PointerViewModelServiceClient grpcClient)
        {
            ...
            OnClickTestCommand = new RelayCommand<MouseEventArgs>(RemoteExecute_OnClickTest);
        ...
        private void RemoteExecute_OnClickTest(MouseEventArgs e)
        {
            ...
            try
            {
                _ = _grpcClient.OnClickTestAsync(new Pointer.ViewModels.Protos.OnClickTestRequest { E = e }, cancellationToken: _cts.Token);
            }
