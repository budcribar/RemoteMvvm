...
{
    public partial class PointerViewModel : IEquatable<PointerViewModel>
    {
        private static readonly string[] __eqProps = new []{"Show","ShowSpinner","ClicksToPass","Is3Btn","TestTimeoutSec","Instructions","ShowCursorTest","ShowConfigSelection","ShowClickInstructions","ShowTimer","ShowBottom","TimerText","SelectedDevice","LastClickCount"};

        public bool Equals(PointerViewModel? other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
            return DeepDiff(other).Count == 0;
        }
        public override bool Equals(object? obj) => Equals(obj as PointerViewModel);
        ...
        public List<string> DeepDiff(PointerViewModel? other)
        {
