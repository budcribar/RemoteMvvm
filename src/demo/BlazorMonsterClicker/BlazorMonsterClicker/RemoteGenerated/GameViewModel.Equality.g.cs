...
{
    public partial class GameViewModel : IEquatable<GameViewModel>
    {
        private static readonly string[] __eqProps = new []{"MonsterName","MonsterMaxHealth","MonsterCurrentHealth","PlayerDamage","GameMessage","IsMonsterDefeated","CanUseSpecialAttack","IsSpecialAttackOnCooldown"};
        ...
        public List<string> DeepDiff(GameViewModel? other)
        {
