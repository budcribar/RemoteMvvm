...
{
    public static string Generate(string vmName, string protoNs, string serviceName, string vmNamespace, string clientNamespace, string baseClass, string runType = "wpf", bool hasParameterlessConstructor = true)
    {
