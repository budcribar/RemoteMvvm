...
public class WinFormsClientUIGenerator : UIGeneratorBase
{
    ...
    public override string GenerateProgram(string protoNs, string serviceName)
    {
        ...
        sb.AppendLine("                {");
        sb.AppendLine("                    ShowClientPropertyEditor(e.Node, detailLayout, path => RefreshTreeView(path));");
        sb.AppendLine("                };");
        sb.AppendLine();
        sb.AppendLine("                // Populate the tree using compile-time metadata");
        sb.Append(IndentCodeBlock(GenerateHierarchicalTreeLogic("tree", "vm", ClientClassName), "                "));
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("        private static void ShowClientPropertyEditor(TreeNode? selectedNode, TableLayoutPanel detailLayout, Action<string?> refreshTree)");
        sb.AppendLine("        {");
        ...
        sb.AppendLine("                {");
        sb.AppendLine("                    Text = \"Collection editing is not supported from the WinForms client.\",");
        sb.AppendLine("                    AutoSize = true,");
