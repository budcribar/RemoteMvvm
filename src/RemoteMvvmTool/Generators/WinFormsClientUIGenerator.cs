...
public class WinFormsClientUIGenerator : UIGeneratorBase
{
    ...
    public WinFormsClientUIGenerator(string projectName, string modelName, List<PropertyInfo> properties, List<CommandInfo> commands, string clientClassName, string clientNamespace)
    ...
    protected override string GeneratePropertyDetailsPanel()
    {
        ...
        sb.AppendLine("                var connectionLabel = new Label");
        sb.AppendLine("                {");
        sb.AppendLine("                    Text = \"Connection Status\",");
        sb.AppendLine("                    Font = new Font(\"Segoe UI\", 12, FontStyle.Bold),");
        sb.AppendLine("                    AutoSize = true");
        sb.AppendLine("                };");
        sb.AppendLine("                flow.Controls.Add(connectionLabel);");
        sb.AppendLine();
        sb.AppendLine("                var status = new Label { AutoSize = true, Font = new Font(\"Segoe UI\", 9, FontStyle.Regular) };");
        sb.AppendLine("                try");
        sb.AppendLine("                {");
        ...
        sb.AppendLine("                {");
        sb.AppendLine("                    Text = \"Property Details (Client)\",");
        sb.AppendLine("                    AutoSize = true,");
