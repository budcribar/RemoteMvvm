...
public static class TsProjectGenerator
{
    ...
    {
        return $"{{\n  \"name\": \"{projectName.ToLowerInvariant()}\",\n  \"version\": \"1.0.0\",\n  \"scripts\": {{\n    \"protoc\": \"protoc --plugin=protoc-gen-ts=\\\".\\\\node_modules\\\\.bin\\\\protoc-gen-ts.cmd\\\" --plugin=protoc-gen-grpc-web=\\\".\\\\node_modules\\\\protoc-gen-grpc-web\\\\bin\\\\protoc-gen-grpc-web.exe\\\" --js_out=\\\"import_style=commonjs,binary:./src/generated\\\" --grpc-web_out=\\\"import_style=typescript,mode=grpcwebtext:./src/generated\\\" -Iprotos -Inode_modules/protoc/include {projectName}Service.proto\",\n    \"build\": \"webpack --mode development\",\n    \"dev\": \"webpack serve --mode development --open\"\n  }},\n  \"devDependencies\": {{\n    \"ts-loader\": \"^9.5.2\",\n    \"typescript\": \"^5.0.0\",\n    \"webpack\": \"^5.0.0\",\n    \"webpack-cli\": \"^4.0.0\",\n    \"webpack-dev-server\": \"^4.0.0\",\n    \"ts-protoc-gen\": \"0.15.0\"\n  }},\n  \"dependencies\": {{\n    \"grpc-web\": \"^1.5.0\",\n    \"google-protobuf\": \"3.21.4\",\n    \"protoc\": \"^1.1.3\",\n    \"protoc-gen-grpc-web\": \"^1.5.0\"\n  }}\n}}";
    }
